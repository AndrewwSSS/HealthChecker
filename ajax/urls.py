...
urlpatterns = [
    ...
    path("add_power_training_exercise", CreatePowerExerciseView.as_view(), name="create-power-training-exercise"),
    ...
    path("add_approach", CreateApproachView.as_view(), name="create-approach"),
    path("trainings/delete_training", DeleteTrainingView.as_view(), name="delete-training"),
    path("add_dish_to_meal", CreateDishCountView.as_view(), name="create-dish-count"),
    ...
    path("get_training_type_ratio", GetTrainingsTypeRatioView.as_view(), name="get-training-type-ratio"),
