# Generated by Django 5.0.6 on 2024-07-12 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('climb', models.FloatField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repeats', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.AddConstraint(
            model_name='cycling',
            constraint=models.CheckConstraint(check=models.Q(('start__lt', models.F('end'))), name='end_date_grater_than_start_date'),
        ),
        migrations.AddConstraint(
            model_name='jogging',
            constraint=models.CheckConstraint(check=models.Q(('start__lt', models.F('end'))), name='end_date_grater_than_start_date'),
